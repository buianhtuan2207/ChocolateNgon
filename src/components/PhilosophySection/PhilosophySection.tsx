                ...
                <div className="row align-items-center g-4">
                    ...
                    <div className="col-lg-6 ps-lg-5">
                        ...
                        <div className="content-text mb-4">
                            <p className="mb-2">
                                Tại ChocoLux, chúng tôi không theo đuổi những sự pha trộn cầu kỳ. Chúng tôi tôn vinh bản sắc của từng vùng đất thông qua những hạt cacao đơn nguồn (single-origin).
                            </p>
                            <p>
